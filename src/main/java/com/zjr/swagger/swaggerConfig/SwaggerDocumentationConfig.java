package com.zjr.swagger.swaggerConfig;
...
public class SwaggerDocumentationConfig {
	...
	public Docket customImplementation() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.zjr.swagger"))
				.apis(RequestHandlerSelectors.basePackage("com.zjr.swagger.controller")).build()
				.apiInfo(apiInfo());
	}
